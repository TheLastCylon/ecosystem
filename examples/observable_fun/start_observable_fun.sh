...
export ECOENV_TCP_FORTUNE_0=127.0.0.1:8100
export ECOENV_TCP_JOKER_0=127.0.0.1:8200
export ECOENV_TCP_LOTTERY_0=127.0.0.1:8300
export ECOENV_TCP_MAGIC_EIGHT_BALL_0=127.0.0.1:8400
export ECOENV_TCP_TIME_REPORTER_0=127.0.0.1:8500
export ECOENV_TCP_ROUTER_0=127.0.0.1:8600
export ECOENV_TCP_TRACKER_0=127.0.0.1:8700
export ECOENV_TCP_EKOSIS_PROMETHEUS_0=127.0.0.1:8800
